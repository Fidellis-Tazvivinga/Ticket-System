...
export default class EditTicket extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(`${process.env.REACT_APP_API}/tickets` + this.props.match.params.id)
            .then(res => {
                this.setState({
    ...
    onSubmit(e) {
        ...
        axios.post(`${process.env.REACT_APP_API}/tickets/update/` + this.props.match.params.id, ticket)
